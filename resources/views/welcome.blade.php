...
@section('title', 'Dahlan Property - Marketplace Properti Terbaik')
...
<div class="space-y-16 animate-slideIn">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <div class="mt-8 flex gap-4">
                        <a href="{{ route('properties.index') }}" class="gradient-primary text-white px-8 py-4 rounded-xl soft-shadow hover:soft-shadow transition-all duration-300">
                            Lihat Properti
                        </a>
                        <a href="{{ route('contact') }}" class="bg-gray-100 text-gray-700 px-8 py-4 rounded-xl hover:bg-gray-200 transition-all duration-300">
                            Hubungi Kami
                        </a>
                    </div>
                </div>
    ...
    <section class="py-16">
        ...
        <div class="text-center mt-12">
            <a href="{{ route('properties.index') }}" class="inline-flex items-center gap-2 gradient-primary text-white px-8 py-4 rounded-xl soft-shadow hover:soft-shadow transition-all duration-300">
    ...
    <section class="gradient-primary rounded-3xl soft-shadow p-16 relative overflow-hidden">
        ...
        <div class="relative z-10 text-center text-white max-w-3xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('register') }}" class="bg-white text-primary px-8 py-4 rounded-xl font-semibold hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                    Daftar Sekarang
                </a>
                <a href="{{ route('contact') }}" class="bg-transparent border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-primary transition-all duration-300">
                    Hubungi Kami
                </a>
            </div>
        </div>
