...
<body>
    ...
    <!-- Custom JS -->
    <?php echo $__env->make('layouts.app-js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> ← PAKAI DASH, BUKAN TITIK!

    <!-- Page Specific Scripts -->
    <?php echo $__env->yieldContent('scripts'); ?>
</body><?php /**PATH C:\xampp\htdocs\dahlan_project\resources\views/layouts/app.blade.php ENDPATH**/ ?>