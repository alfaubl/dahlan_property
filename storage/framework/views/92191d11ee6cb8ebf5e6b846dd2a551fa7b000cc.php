                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="d-flex gap-3 align-items-center flex-wrap">
                            ...
                            <span class="badge-premium">
                                <i class="fas fa-building me-2"></i>Total <?php echo e($totalProperties ?? 0); ?> Properti
                            </span>
                            <span class="badge-premium">
                                <i class="fas fa-user me-2"></i><?php echo e($user->name); ?>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h2 class="display-6 fw-bold mb-0"><?php echo e($totalProperties ?? 0); ?></h2>
                            <small class="text-success">
                                <i class="fas fa-arrow-up"></i> +<?php echo e($totalProperties ?? 0); ?> terdaftar
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="mt-3 mt-md-0">
                            <a href="<?php echo e(route('properties.index')); ?>" class="btn btn-primary me-2 px-4 py-2 rounded-pill">
                                <i class="fas fa-list me-2"></i> Semua Properti
                            </a>
                            <a href="<?php echo e(route('properties.create')); ?>" class="btn btn-success px-4 py-2 rounded-pill">
