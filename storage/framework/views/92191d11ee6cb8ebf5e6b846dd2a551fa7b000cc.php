                        ...
                        <div>
                            ...
                            <div class="d-flex gap-2 align-items-center flex-wrap mt-2">
                                ...
                                <span class="property-badge">
                                    ...
                                    <?php echo e($totalProperties ?? 0); ?> Total Properti
                                </span>
                                <span class="property-badge">
            ...
            <div class="col-12">
                <div class="quick-actions-card">
                    ...
                    <div class="d-flex gap-2">
                        <a href="<?php echo e(route('properties.index')); ?>" class="btn-premium btn-premium-primary">
                            <i class="fas fa-list me-2"></i>
                            Semua Properti
                        </a>
                        <a href="<?php echo e(route('properties.create')); ?>" class="btn-premium btn-premium-success">
