        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h1 class="display-5 fw-bold mb-2">Selamat Datang, <?php echo e($user->name); ?>! 👋</h1>
                        <div class="d-flex gap-3 align-items-center">
                            <span class="badge-premium">
                                <i class="fas fa-calendar-alt me-2"></i><?php echo e(now()->format('l, d F Y')); ?>

                            </span>
                            <span class="badge-premium">
                                <i class="fas fa-clock me-2"></i><?php echo e(now()->format('H:i')); ?> WIB
                            </span>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h2 class="display-5 fw-bold mb-0"><?php echo e($totalProperties); ?></h2>
                    ...
                    <div class="mt-3 pt-2 border-top">
                        <a href="<?php echo e(route('properties.index')); ?>" class="text-decoration-none small fw-bold">
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h2 class="display-5 fw-bold mb-0"><?php echo e($totalCartItems); ?></h2>
                            <small class="text-warning">
                                <i class="fas fa-clock"></i> <?php echo e($totalCartItems); ?> item pending
                            </small>
                        </div>
                    </div>
                    <div class="mt-3 pt-2 border-top">
                        <a href="<?php echo e(route('cart.index')); ?>" class="text-decoration-none small fw-bold">
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Member since <?php echo e($user->created_at->format('M Y')); ?></small>
                        </div>
                    </div>
                    <div class="mt-3 pt-2 border-top">
                        <a href="<?php echo e(route('profile.edit')); ?>" class="text-decoration-none small fw-bold">
            ...
            <div class="card border-0 shadow-lg rounded-4 h-100">
                ...
                <div class="card-body">
                    <div class="activity-timeline">
                        ...
                        <div class="activity-item">
                            <p class="mb-1 fw-bold"><?php echo e($totalCartItems); ?> Item di Keranjang</p>
                            <small class="text-muted">
                        ...
                        <div class="activity-item">
                            <p class="mb-1 fw-bold"><?php echo e($totalProperties); ?> Properti Terdaftar</p>
                            <small class="text-muted">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-lg-3 col-md-6">
                            <a href="<?php echo e(route('properties.index')); ?>" class="text-decoration-none">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="<?php echo e(route('cart.index')); ?>" class="text-decoration-none">
                                <div class="quick-action-btn">
                                    <i class="fas fa-shopping-cart fa-2x text-success mb-3"></i>
                                    <p class="fw-bold mb-1">Keranjang</p>
                                    <small class="text-muted"><?php echo e($totalCartItems); ?> item</small>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <a href="<?php echo e(route('properties.create')); ?>" class="text-decoration-none">
                                <div class="quick-action-btn">
