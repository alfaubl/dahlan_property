...
<?php $__env->startSection('title', 'Dahlan Property - Marketplace Properti Terbaik Indonesia'); ?>

<?php $__env->startSection('styles'); ?>
    <?php echo $__env->make('partials.css.welcome-css', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="container hero-content">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                ...
                <!-- Search Form -->
                <form action="<?php echo e(route('properties.index')); ?>" method="GET" class="search-form">
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="text-center mt-5">
            <a href="<?php echo e(route('properties.index')); ?>" class="btn btn-primary btn-glow px-5 py-3">
...
<?php $__env->startSection('scripts'); ?>
    <?php echo $__env->make('partials.js.welcome-js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
